...
import { ChevronDown, Bell, LogOut, UserPlus } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
              ...
              <DropdownMenu>
                ...
                <DropdownMenuSeparator /> */}
                  {user?.role === "IT_Admin" && (
                    <>
                      <DropdownMenuItem
                        className="cursor-pointer gap-2 focus:bg-blue-50 dark:focus:bg-blue-900/10"
                        onClick={() => setIsRegisterModalOpen(true)}
                      >
                        <UserPlus size={16} className="text-blue-500" /> Register User
                      </DropdownMenuItem>
